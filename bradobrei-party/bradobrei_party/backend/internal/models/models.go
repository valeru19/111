...
type User struct {
	...
	// MustSetPassword — сотрудник ещё не задавал пароль (найм без пароля); вход только через activate-employee.
	MustSetPassword bool `gorm:"default:false;not null" json:"must_set_password"`
